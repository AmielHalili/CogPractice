// POST /bank/customer/{username}/deposit
...
export const handler = withHandler(async (event) => {
  ...
  const newBalance = await bankService.executeDeposit(username, amount);
  return success({ message: `Deposited $${amount}`, newBalance });
});
